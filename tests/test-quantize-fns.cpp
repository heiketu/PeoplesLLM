    ...
    for (int i = 0; i < GGML_TYPE_COUNT; i++) {
        ...
        if (qfns_cpu->from_float && qfns->to_float) {
            ...
            const float max_quantization_error =
                ...
                type == GGML_TYPE_Q3_R    ? MAX_QUANTIZATION_TOTAL_ERROR_3BITS :
                type == GGML_TYPE_UDNL_MX ? MAX_QUANTIZATION_TOTAL_ERROR_3BITS : // 3.375 bpw, W2/W3/W4 mix
            ...
            const float max_allowed_error = type == GGML_TYPE_Q2_K || type == GGML_TYPE_IQ2_XS || type == GGML_TYPE_IQ2_XXS ||
                type == GGML_TYPE_IQ3_XXS || type == GGML_TYPE_IQ3_S || type == GGML_TYPE_IQ2_S || type == GGML_TYPE_UDNL_MX
