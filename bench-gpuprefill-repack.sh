...
cd $WT
ENV_BASE="LLAMA_LAYER_MAJOR_DEVICE_HC=2 GGML_CUDA_MOE_PP_MIN_TOKENS=2048 GGML_CUDA_MOE_PP_PREFETCH=3 GGML_CUDA_MOE_PP_DUAL=0 GGML_CUDA_MOE_PP_EP=1 GGML_CUDA_MOE_PP_EP_MIN_TOKENS=2048 GGML_CUDA_P2P=1 GGML_CUDA_BATCHED_TOPK=1 GGML_CUDA_DSV4_KV_REUSE=1 GGML_CUDA_MOE_PP_DEFER_PREFETCH=1 GGML_CUDA_MOE_PP_PIPE=1"
